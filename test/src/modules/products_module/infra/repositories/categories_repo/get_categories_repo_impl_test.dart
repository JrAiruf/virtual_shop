...
import 'package:virtual_shop/src/modules/products_module/infra/repositories/categories_repo/get_categories_repo_impl.dart';
...
void main() {
  ...
  test('Should return a ProductModuleErrors case fail', () async {
    when(datasource.getCategoryById(any)).thenThrow(Exception());
